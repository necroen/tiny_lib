...
#define __TH_TENSOR_APPLYX_PREAMBLE(TYPE, TENSOR, DIM, ALLOW_CONTIGUOUS) \
  ...
  int *TENSOR##_counter = NULL, *TENSOR##_sizes = NULL, *TENSOR##_strides = NULL, *TENSOR##_dimOffset = NULL; \
  int TENSOR##_stride = 0, TENSOR##_size = 0, TENSOR##_dim = 0, TENSOR##_i, TENSOR##_n; \
  ...
  {                                                                   \
    ...
    if (!TENSOR##_contiguous) {                                               \
      ...
      printf("TENSOR##_size = %d\n",TENSOR##_size);printf("TENSOR##_stride = %d\n",TENSOR##_stride); \
    }                                                                           \
  }                                                                             \
  TENSOR##_i = 0;
